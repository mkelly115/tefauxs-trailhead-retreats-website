  ...
  return (
    <div className='grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center'>
      ...
      <div className='col-span-2'>
        <Image
          src={image2}
          alt='Family that manages Tefauxs Traihead Retreats'
          placeholder='blur'
        />
      </div>
      ...
      <div className='col-span-3'>
        ...
        <div className='space-y-8'>
          <p>
            Since 1962, Tefaux's Trailhead Retreats has been a cherished
          ...
          <p>
            Over the years, we've maintained the essence of Tefaux's Trailhead
            ...
            just a guest; you're part of our extended family. So join us at The
